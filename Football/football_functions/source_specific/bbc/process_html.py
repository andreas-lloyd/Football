...
def extract_headlines(html_content, modifier, logger):
    ...
    if modifier:
        ...
        for i, article in enumerate(articles):
            ...
            # Making a change here - will only check for http which is what is necessary
            if 'http://' not in article_link or 'https://' not in article_link:
        ...
        for i, title in enumerate(article_titles):
            ...
            if 'http://' not in article_links[i] or 'https://' not in article_links[i]:
